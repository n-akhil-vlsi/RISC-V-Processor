...
Add all Verilog files under RTL/ as design sources.
Add the desired testbench from Test_Bench/TOP_tb/ as a simulation source.
Ensure Memory/program.mem is accessible to the simulation (referenced by instruction_memory.v).
Run Behavioral Simulation.
Select the desired case (riscv_processor_tb_case1_normal.v through riscv_processor_tb_case9_reset.v).
Inspect the resulting waveform/results.
