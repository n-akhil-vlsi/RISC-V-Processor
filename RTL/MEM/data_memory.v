module data_memory(
    ...
    input wire [2:0] funct3,      // NEW: selects byte/halfword/word width + sign/zero extend
...
assign word_addr   = address[31:2];   //LSB 2 bits are ignored because they are always 0-aligned for words.
